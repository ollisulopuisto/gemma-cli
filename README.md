...
### Sandboxing Levels
- **`permissive`** (Default): **Inherits your user's read permissions** (it can see what you can see), but **strictly restricts all write/delete operations** exclusively to the current project and allowed paths.
